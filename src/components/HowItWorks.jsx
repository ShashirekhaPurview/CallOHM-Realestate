...
function StepCard({ step, flip = false }) {
  return (
    <div className={`flex items-start gap-3 p-5 bg-white rounded-2xl border border-orange-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 ${flip ? 'flex-row-reverse text-right' : ''}`}>
      <div
