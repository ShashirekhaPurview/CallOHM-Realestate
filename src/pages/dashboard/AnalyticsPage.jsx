...
export default function AnalyticsPage() {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-[20px] font-extrabold text-[#1c0700]">Analytics</h2>
        <p className="text-[13px] text-amber-900/40 mt-0.5">Performance charts and campaign reports</p>
      </div>
